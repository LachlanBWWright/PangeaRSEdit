...
game_docs           = ["CHANGELOG.md", "docs/*.md", "docs/Disc*.jpg", "docs/*.pdf"]

sdl_ver             = "3.2.2"
appimagetool_ver    = "1.9.0"

lib_hashes = {  # sha-256
    f"SDL3-{sdl_ver}.dmg":              "b5169251cc8504f4b888a3603e3a35b5f77ba3a86ecab6b50729e9782af01d9f",
    f"SDL3-{sdl_ver}.tar.gz":           "d3dcf1b2f64746be0f248ef27b35aec4f038dafadfb83491f98a7fecdaf6efec",
    f"SDL3-devel-{sdl_ver}-VC.zip":     "2422ffaf6ed9c81007e472ac248d22be7cf469acdbe05abde932d718c4385095",
