...
```
git clone --recurse-submodules https://github.com/jorio/BillyFrontier
cd BillyFrontier
python3 build.py
```
...
1. Prep the Xcode project:
    ...
    ```
1. Now you can open `build/BillyFrontier.xcodeproj` in Xcode, or you can just go ahead and build the game:
    ```
    cmake --build build --config RelWithDebInfo
    ```
1. The game gets built in `build/RelWithDebInfo/BillyFrontier.app`. Enjoy!
...
1. Prep the Visual Studio solution:
    ...
    ```
1. Now you can open `build/BillyFrontier.sln` in Visual Studio, or you can just go ahead and build the game:
    ```
    cmake --build build --config Release
    ```
1. The game gets built in `build/Release/BillyFrontier.exe`. Enjoy!
