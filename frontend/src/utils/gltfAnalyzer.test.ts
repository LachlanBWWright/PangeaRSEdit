...
describe("gltfAnalyzer", () => {
  ...
  test("splitGLTFByNodes should create separate documents for each node", async () => {
    ...
    if (!doc) expect.fail("expected document");
