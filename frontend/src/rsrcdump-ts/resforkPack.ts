...
export function packResourceFork(fork: ResourceFork): Uint8Array {
  ...
  view.setUint32(pos, dataOffset, false); pos += 4;
  view.setUint32(pos, mapOffset, false); pos += 4;
  view.setUint32(pos, dataSize, false); pos += 4;
  ...
  view.setUint16(pos, typeListOffsetInMap, false); pos += 2;
  view.setUint16(pos, nameListOffsetInMap, false); pos += 2;
