...
export const skeletonSpecs = [
  ...
  "BonP:H+:pointIndex",
  "Bone:h32sh3f2H8L:parentBone,name,unnamedPadding,coordX,coordY,coordZ,numPointsAttachedToBone,numNormalsAttachedToBone,reserved0,reserved1,reserved2,reserved3,reserved4,reserved5,reserved6,reserved7",
