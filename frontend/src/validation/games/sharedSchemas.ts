/**
 * Shared validation schema factory for games with simplified headers
 *
 * Used by: Billy Frontier, Nanosaur 2, Bugdom 2
 * These games use simplified header (no numTilePages/numTiles) and simplified STgd (no isEmpty)
 */
...
/**
 * Creates a level schema for games with simplified headers and STgd
 */
export function createSimplifiedLevelSchema() {
  return z
    .object({
