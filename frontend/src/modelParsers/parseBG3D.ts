...
function convertSkeletonResourceToBG3D(
  ...
  boneEntries.forEach(([boneId, boneEntry]) => {
    ...
    bones.push({
      ...
      reserved0: boneObj.reserved0 || 0,
      reserved1: boneObj.reserved1 || 0,
      reserved2: boneObj.reserved2 || 0,
      reserved3: boneObj.reserved3 || 0,
      reserved4: boneObj.reserved4 || 0,
      reserved5: boneObj.reserved5 || 0,
      reserved6: boneObj.reserved6 || 0,
      reserved7: boneObj.reserved7 || 0,
      pointIndices,
      normalIndices,
    });
  });
