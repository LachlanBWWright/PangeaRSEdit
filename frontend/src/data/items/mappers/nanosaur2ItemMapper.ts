 ...
 * - level1.bg3d  - Level 1: Forest
 * - level2.bg3d  - Level 2: Desert
 * - level3.bg3d  - Level 3: Swamp
 *
...
export const NANOSAUR2_LEVEL_MODEL_FILES: Record<number, string> = {
  0: "level1.bg3d",  // Forest
  1: "level2.bg3d",  // Desert
  2: "level3.bg3d",  // Swamp
};
...
const NANOSAUR2_BASE_MAPPINGS: Record<number, UniversalItemModelMapping> = {
  ...
  // ---- LEVEL 1: FOREST (level1.bg3d) ----
  // LEVEL1_ObjType_Tree_Birch_HighRed = 2 ... Tree_Birch_Flat = 8
  [ItemType.BirchTree]: {
    modelFile: "level1.bg3d", modelPath: "models", modelIndex: 2,
  ...
  [ItemType.PineTree]: {
    modelFile: "level1.bg3d", modelPath: "models", modelIndex: 9,
  ...
  [ItemType.RiverRock]: {
    modelFile: "level1.bg3d", modelPath: "models", modelIndex: 37,
    variants: { 0: { modelIndex: 37 }, 1: { modelIndex: 38 } },
  },

  // LEVEL1_ObjType_GasMound1 = 39, GasMound2 = 40, GasMound3 = 41
  [ItemType.GasMound]: {
    modelFile: "level1.bg3d", modelPath: "models", modelIndex: 39,
    variants: { 0: { modelIndex: 39 }, 1: { modelIndex: 40 }, 2: { modelIndex: 41 } },
  },

  // LEVEL1_ObjType_AirMine_Base = 43, Chain = 44, Mine = 45
  [ItemType.AirMine]: { modelFile: "level1.bg3d", modelPath: "models", modelIndex: 43, groupSize: 3 },

  // LEVEL1_ObjType_TowerTurret_Base = 46, Turret = 47, Wheel = 48, Gun = 49
  [ItemType.TowerTurret]: { modelFile: "level1.bg3d", modelPath: "models", modelIndex: 46, groupSize: 4 },
  ...
  [ItemType.Asteroid]: {
    modelFile: "level3.bg3d", modelPath: "models", modelIndex: 27,
    variants: { 0: { modelIndex: 27 }, 1: { modelIndex: 28 } },
  },

  // LEVEL3_ObjType_FallenTree1 = 37, FallenTree2 = 38
  [ItemType.SwampFallenTree]: {
    modelFile: "level3.bg3d", modelPath: "models", modelIndex: 37,
    rotationParam: { paramIndex: 0, rotationType: ROTATION_8_WAY },
    variants: { 0: { modelIndex: 37 }, 1: { modelIndex: 38 } },
  },
  ...
  [ItemType.SwampStump]: {
    modelFile: "level3.bg3d", modelPath: "models", modelIndex: 39,
