...
const NANOSAUR2_BASE_MAPPINGS: Record<number, UniversalItemModelMapping> = {
  ...
  [ItemType.BirchTree]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 2, scale: 1.2,
  ...
  [ItemType.PineTree]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 9, scale: 1.2,
  ...
  [ItemType.SmallTree]: { modelFile: "forest.bg3d", modelPath: "models", modelIndex: 16, scale: 1.0 },

  // LEVEL1_ObjType_FallenTree = 17
  // Source/Items/Trees.c AddFallenTree: scale = 1.7
  [ItemType.FallenTree]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 17, scale: 1.7,
  ...
  [ItemType.TreeStump]: { modelFile: "forest.bg3d", modelPath: "models", modelIndex: 18, scale: 1.3 },
  ...
  [ItemType.BentPineTree]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 19, groupSize: 2, scale: 1.2,
    rotationParam: { paramIndex: 1, rotationType: ROTATION_8_WAY },
  },
  ...
  [ItemType.Grass]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 23, scale: 2.0,
  ...
  [ItemType.Fern]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 25, scale: 1.4,
  ...
  [ItemType.BerryBush]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 27, scale: 2.0,
  ...
  [ItemType.CatTail]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 29, scale: 1.4,
  ...
  [ItemType.Rock]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 31, scale: 2.0,
  ...
  [ItemType.RiverRock]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 37, scale: 2.0,
  ...
  [ItemType.GasMound]: {
    modelFile: "forest.bg3d", modelPath: "models", modelIndex: 39, scale: 3.0,
  ...
  [ItemType.AirMine]: { modelFile: "forest.bg3d", modelPath: "models", modelIndex: 43, groupSize: 3, scale: 1.2 },
  ...
  [ItemType.DesertTree]: {
    modelFile: "desert.bg3d", modelPath: "models", modelIndex: 5, scale: 1.2,
  ...
  [ItemType.BurntDesertTree]: {
    modelFile: "desert.bg3d", modelPath: "models", modelIndex: 15, scale: 1.2,
  ...
  // Source/Items/Trees.c: scale = 1.2 + RandomFloat() * .3f
  [ItemType.PalmTree]: {
    modelFile: "desert.bg3d", modelPath: "models", modelIndex: 17, scale: 1.2,
  ...
  [ItemType.DesertBush]: {
    modelFile: "desert.bg3d", modelPath: "models", modelIndex: 23, scale: 2.0,
  ...
  [ItemType.PalmBush]: {
    modelFile: "desert.bg3d", modelPath: "models", modelIndex: 27, scale: 2.0,
  ...
  [ItemType.Cactus]: {
    modelFile: "desert.bg3d", modelPath: "models", modelIndex: 30, scale: 2.0,
  ...
  [ItemType.HydraTree]: {
    modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 2, scale: 1.5,
  ...
  [ItemType.OddTree]: {
    modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 5, scale: 1.3,
  ...
  [ItemType.GeckoPlant]: {
    modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 9, scale: 2.0,
  ...
  [ItemType.SproutPlant]: { modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 12, scale: 2.5 },
  ...
  [ItemType.Ivy]: {
    modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 16, scale: 2.0,
    variants: {
      0: { modelIndex: 16 }, 1: { modelIndex: 17 }, 2: { modelIndex: 18 }, 3: { modelIndex: 19 }, 4: { modelIndex: 20 },
    },
  },
  ...
  [ItemType.Asteroid]: {
    modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 26, scale: 4.0,
    variants: { 0: { modelIndex: 26 }, 1: { modelIndex: 27 }, 2: { modelIndex: 28 } },
  },
  ...
  [ItemType.SwampStump]: {
    modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 39, scale: 1.3,
 ...
 */
const NANOSAUR2_LEVEL_SPECIFIC_MAPPINGS: Record<number, Record<number, UniversalItemModelMapping>> = {
  0: {
  ...
  1: {
    ...
    [ItemType.AirMine]: { modelFile: "desert.bg3d", modelPath: "models", modelIndex: 2, groupSize: 3, scale: 1.2 },
    // Desert: LEVEL2_ObjType_TowerTurret_Base = 48, Turret = 49, Wheel = 50, Gun = 51
    [ItemType.TowerTurret]: { modelFile: "desert.bg3d", modelPath: "models", modelIndex: 48, groupSize: 4 },
    // Desert: LEVEL2_ObjType_Rock_Small1 = 39 ... Rock_Large3 = 44 (Items.c: scale = 2.0)
    [ItemType.Rock]: {
      modelFile: "desert.bg3d", modelPath: "models", modelIndex: 39, scale: 2.0,
      variants: { 0: { modelIndex: 39 }, 1: { modelIndex: 40 }, 2: { modelIndex: 41 }, 3: { modelIndex: 42 }, 4: { modelIndex: 43 }, 5: { modelIndex: 44 } },
    },
    // Desert: LEVEL2_ObjType_Grass = 45, GrassPatch = 46 (Bushes.c: scale = 2.0)
    [ItemType.Grass]: {
      modelFile: "desert.bg3d", modelPath: "models", modelIndex: 45, scale: 2.0,
      variants: { 0: { modelIndex: 45 }, 1: { modelIndex: 46 } },
    },
  },
  2: {
    // Swamp: LEVEL3_ObjType_AirMine_Base = 29, Chain = 30, Mine = 31 (Mines.c: scale = 1.2)
    [ItemType.AirMine]: { modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 29, groupSize: 3, scale: 1.2 },
    // Swamp: LEVEL3_ObjType_TowerTurret_Base = 33, Turret = 34, Wheel = 35, Gun = 36
    [ItemType.TowerTurret]: { modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 33, groupSize: 4 },
    // Swamp: LEVEL3_ObjType_Grass_Single = 13, Grass_Small = 14, Grass_Patch = 15 (Bushes.c: scale = 2.0)
    [ItemType.Grass]: {
      modelFile: "swamp.bg3d", modelPath: "models", modelIndex: 13, scale: 2.0,
      variants: { 0: { modelIndex: 13 }, 1: { modelIndex: 14 }, 2: { modelIndex: 15 } },
    },
  },
};
...
export class Nanosaur2ItemMapper implements GameItemModelMapper {
  ...
  getMapping(
    ...
    if (itemType === ItemType.Ivy && params) {
      ...
      return {
        modelFile: "swamp.bg3d", modelPath: "models",
    ...
    if (NANOSAUR2_LEVEL_DEPENDENT_TYPES.has(itemType)) {
      const levelOverrides = NANOSAUR2_LEVEL_SPECIFIC_MAPPINGS[effectiveLevelNum];
      const override = levelOverrides?.[itemType];
      if (override) {
        return this.resolveVariant(override, params);
      }
    }
  ...
  hasModel(itemType: number): boolean {
    return NANOSAUR2_BASE_MAPPINGS[itemType] !== undefined || NANOSAUR2_LEVEL_DEPENDENT_TYPES.has(itemType);
  }
