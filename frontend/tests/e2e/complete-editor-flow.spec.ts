...
async function waitForLevelLoad(page) {
...
test.describe('Complete Editor Flow - All Games', () => {
  ...
  test('Otto Matic - Load and Download Level', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/otto-matic-editor.png', fullPage: true });
  ...
  test('Bugdom - Load and Download Level', async ({ page }) => {
    ...
    if (await bugdomCard.isVisible()) {
      // Upload level file
      const filePath = path.join(__dirname, '../../src/assets/Bugdom1-Level1.ter.rsrc');
      const fileChooserPromise = page.waitForEvent('filechooser');
      ...
      await page.screenshot({ path: 'test-results/bugdom-editor.png', fullPage: true });
  ...
  test('Bugdom 2 - Load and Download Level', async ({ page }) => {
    ...
    if (await bugdom2Card.isVisible()) {
      // Upload level file
      const filePath = path.join(__dirname, '../../src/assets/Bugdom2-Level1.ter.rsrc');
      const fileChooserPromise = page.waitForEvent('filechooser');
      
      // Find the Bugdom 2 upload button
      const uploadButtons = await page.locator('text=Upload Level Data (.ter.rsrc)').all();
      ...
      await page.screenshot({ path: 'test-results/bugdom2-editor.png', fullPage: true });
  ...
  test('Cro-Mag Rally - Load and Download Level', async ({ page }) => {
    ...
    if (await croMagCard.isVisible()) {
      // Upload level file
      const filePath = path.join(__dirname, '../../src/assets/CroMagRally-Level1.ter.rsrc');
      const fileChooserPromise = page.waitForEvent('filechooser');
      ...
      await page.screenshot({ path: 'test-results/cromag-rally-editor.png', fullPage: true });
  ...
  test('Nanosaur 2 - Load and Download Level', async ({ page }) => {
    ...
    if (await nanosaur2Card.isVisible()) {
      // Upload level file
      const filePath = path.join(__dirname, '../../src/assets/Nanosaur2-Level1.ter.rsrc');
      const fileChooserPromise = page.waitForEvent('filechooser');
      ...
      await page.screenshot({ path: 'test-results/nanosaur2-editor.png', fullPage: true });
  ...
  test('Billy Frontier - Load and Download Level', async ({ page }) => {
    ...
    if (await billyCard.isVisible()) {
      // Upload level file
      const filePath = path.join(__dirname, '../../src/assets/BillyFrontier-Level1.ter.rsrc');
      const fileChooserPromise = page.waitForEvent('filechooser');
      ...
      await page.screenshot({ path: 'test-results/billy-frontier-editor.png', fullPage: true });
