...
const games = [
  { name: 'Otto Matic', file: '../../public/assets/ottoMatic/terrain/EarthFarm.ter.rsrc' },
  { name: 'Bugdom', file: '../../public/assets/bugdom/terrain/Lawn.ter.rsrc' },
  { name: 'Bugdom 2', file: '../../public/assets/bugdom2/terrain/Level1_Garden.ter.rsrc' },
  { name: 'Cro-Mag Rally', file: '../../public/assets/croMag/terrain/StoneAge_Jungle.ter.rsrc' },
];
